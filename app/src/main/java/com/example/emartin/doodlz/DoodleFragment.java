...
//Manages the DoodleView and accelerometer event handling
public class DoodleFragment extends Fragment{
    ...
    //Anonmous inner class that implements interface SensorEventListener to process accelerometer events
